...
import com.wss.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "wss");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.wss");
